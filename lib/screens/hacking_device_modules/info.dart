...
class Info extends DeviceModuleBase {
  ...
  Info(HackingDevice hackingDevice, this.title, this.text)
      : super(hackingDevice) {
  ...
  void setTitle(Canvas canvas) {
    var textStyle =
        TextStyle(color: Colors.white, fontFamily: 'Rajdhani', fontSize: 25);
    ...
    var offset = Offset(
        area.left + (area.height * 0.13), area.top + (area.height * 0.11));
    textPainter.layout(
  ...
  void setText(Canvas canvas) {
    var textStyle =
        TextStyle(color: Colors.white, fontFamily: 'Rajdhani', fontSize: 17);
    ...
    var textPainter = TextPainter(
        ...
        textAlign: TextAlign.left);
    var offset = Offset(
        area.left + (area.height * 0.13), area.top + (area.height * 0.27));
    textPainter.layout(
        minWidth: area.width - ((area.height * 0.13) * 2),
        maxWidth: area.width - ((area.height * 0.13) * 2));
    textPainter.paint(canvas, offset);
